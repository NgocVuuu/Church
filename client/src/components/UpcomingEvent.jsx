  ...
  return (
    <section id="su-kien" className="relative py-6 md:py-10 bg-white">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 gap-0 overflow-hidden rounded-md">
        {/* Left: text card */}
  <div className="relative bg-[#cdb79e]/80 text-black p-4 md:p-10 flex flex-col justify-center">
    <div className="uppercase tracking-[0.3em] text-black/80 text-[10px] md:text-xs mb-2 md:mb-4">Sự kiện sắp tới</div>
    <h2 className="font-display text-lg md:text-4xl text-black/90 leading-snug">{title}</h2>

          <div className="mt-3 md:mt-6 text-black/80 space-y-2 md:space-y-3 text-sm md:text-base">
            <div className="inline-flex items-center bg-primary text-black font-medium px-3 py-1.5 rounded">{timeLabel}</div>
          ...
          <div className="mt-4 md:mt-8">
            <a href="#" className="inline-flex items-center bg-primary text-black px-4 md:px-5 py-2 md:py-3 rounded-full font-medium shadow hover:brightness-110 text-sm">Tham gia</a>
          </div>
        </div>
          ...
          <div className="relative z-10 h-full w-full flex flex-col items-center justify-center p-8">
            <div className="grid grid-cols-4 gap-2 md:gap-6 text-white/95">
              <div className="text-center">
                <div className="text-2xl md:text-5xl font-light">{days}</div>
                <div className="mt-1 text-[10px] md:text-sm uppercase tracking-widest">Ngày</div>
              </div>
              <div className="text-center">
                <div className="text-2xl md:text-5xl font-light">{hours}</div>
                <div className="mt-1 text-[10px] md:text-sm uppercase tracking-widest">Giờ</div>
              </div>
              <div className="text-center">
                <div className="text-2xl md:text-5xl font-light">{minutes}</div>
                <div className="mt-1 text-[10px] md:text-sm uppercase tracking-widest">Phút</div>
              </div>
              <div className="text-center">
                <div className="text-2xl md:text-5xl font-light">{seconds}</div>
                <div className="mt-1 text-[10px] md:text-sm uppercase tracking-widest">Giây</div>
              </div>
            </div>

            <a href="#" className="mt-3 md:mt-6 inline-flex items-center bg-[#cdb79e] text-black px-4 md:px-5 py-2 md:py-3 rounded shadow hover:brightness-110 text-sm">Tham gia sự kiện</a>
          </div>
        </div>
      </div>
    </section>
